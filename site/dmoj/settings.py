...
ALLOWED_HOSTS = ["*"]
STATIC_ROOT = '<absolute path>/contest/site/static' # Change absolute path
SITE_ID = 1
SITE_NAME = 'NCCSOFT'
SITE_LONG_NAME = 'NCC CONTEST'
SITE_ADMIN_EMAIL = ''
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'read_default_file': '<absolute path>/contest/site/dmoj/my.cnf', # Change absolute path
        },
    }
}
