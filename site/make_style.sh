...
build_style() {
  ...
  postcss sass_processed/style.css sass_processed/martor-description.css sass_processed/select2-dmoj.css sass_processed/login.css --verbose --use autoprefixer -d $2
}
